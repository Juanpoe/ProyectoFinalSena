...
function MostrarEmpleadosNovedad()
{
    ...
    foreach ($Resultado as $key => $Datos) {
        echo '<option value="' . $Datos["IdUsuario"] . '">' . $Datos["Nombre"] . '</option>';
    }
}
...
function listarNovedad()
{
    ...
    if ($ResultadoContar > 0) {
        foreach ($Resultado as $key => $fila) {
            ...
            echo '<td data-th="Nombre">', $fila['Nombre'], '</td>
            ...
            if ($_SESSION["Rol"] == 1) {
                ...
                if ($fila['EstadoNovedad'] == 1) {
                    echo '<Img src="Assets/Img/Iconos/InEditable.svg" title="Deshabilitado" alt="" class="icon"><Img src="Assets/Img/Iconos/InEditable.svg" title="Deshabilitado" alt="" class="icon"><Img src="Assets/Img/Iconos/InEditable.svg" title="Deshabilitado" alt="" class="icon">';
                } else if ($fila['EstadoNovedad'] == 2) {
                    ...
                    <Img src="../Vista/Assets/Img/Iconos/x.svg" class="icon" title="Rechazar" alt=""></a> </center>';
                } else {
                    echo '<Img src="Assets/Img/Iconos/InEditable.svg" title="Deshabilitado" alt="" class="icon"><Img src="Assets/Img/Iconos/InEditable.svg" title="Deshabilitado" alt="" class="icon"><Img src="Assets/Img/Iconos/InEditable.svg" title="Deshabilitado" alt="" class="icon">';
                }
                echo '</center>
