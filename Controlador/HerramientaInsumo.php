...
function MensajeStock() {
    ...
    if ($minStock !== null) {
        echo '("La Herramienta o Insumo con más baja cantidad es: ' . $minStock['Nombre'] . ' con una cantidad de ' . $minStock['Cantidad'];
    }

    if ($maxStock !== null) {
        echo '("La Herramienta o Insumo con la más alta es: ' . $maxStock['Nombre'] . ' con una cantidad de ' . $maxStock['Cantidad'];
    }
}
