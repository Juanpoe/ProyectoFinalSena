<div class="body">
  ...
  <?php
    ...
    <a onclick='Metodo(\"Particiones/ListarDañadas.php\"); ListarPrestamoDañado(1)' href='#'>Herramientas Dañadas</a>
    <a onclick='Metodo(\"Particiones/ListarSolicitudPrestamo.php\"); ListarPrestamosSolicitados(1)' href='#'>Prestamos Solicitados</a>
    ";
                    }
                    else{   echo" 
                        <a onclick='Metodo(\"Particiones/ListarDañadas.php\"); ListarPrestamoDañado(1)' href='#'>Herramientas Dañadas</a>
                        <a onclick='Metodo(\"Particiones/ListarSolicitudPrestamo.php\"); ListarPrestamosSolicitados(1)' href='#'>Prestamos Solicitados</a>
                        <a onclick='Metodo(\"Particiones/SolicitarPrestamo.php\"); ListarHerramientasSP(1)' href='#'>Solicitar Prestamo</a>
                        ";     
                    }
                    ?> 
  </div>
